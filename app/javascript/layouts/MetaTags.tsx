...
const MetaTags = (props: MetaTagsProps) => {
  ...
  return (
    <Helmet>
      ...
      <link href={getAssetPath("apple-icon-114x114.png")} rel="apple-touch-icon" sizes="114x114" />
      <link href={getAssetPath("apple-icon-120x120.png")} rel="apple-touch-icon" sizes="120x120" />
      <link href={getAssetPath("apple-icon-144x144.png")} rel="apple-touch-icon" sizes="144x144" />
      <link href={getAssetPath("apple-icon-152x152.png")} rel="apple-touch-icon" sizes="152x152" />
      <link href={getAssetPath("apple-icon-180x180.png")} rel="apple-touch-icon" sizes="180x180" />
      <link
