// Vendored from @bloom-housing/ui-components src/blocks/ImageCard.tsx
...
import { AppearanceSizeType, AppearanceStyleType } from "./AppearanceTypes"
        ...
        <figure className={innerClasses.join(" ")} ref={imgParentRef}>
          {props.imageUrl ? (
            <img
              ...
              // eslint-disable-next-line react-hooks/immutability -- ref callback collects img elements for useFallbackImage; matches upstream
