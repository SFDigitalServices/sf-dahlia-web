// Vendored from @bloom-housing/ui-components src/tables/StackedTable.tsx
          ...
          content: (
            ...
            >
              {Array.isArray(dataRow[item])
                ...
                : // eslint-disable-next-line @typescript-eslint/no-unsafe-argument -- upstream indexes a union type; avoid behavior drift
