...
const B2Contact = ({ nextPage, prevPage, saveData, applicationData }) => {
  ...
  const onSubmit = (data, e) => {
    console.log("b1-name SUCCESS", data, e)
  ...
  const onError = (errors, e) => {
    console.log("b1-name ERROR", errors, e)
  ...
  useEffect(() => console.log(applicationData))
