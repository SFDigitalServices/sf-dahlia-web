  ...
  return (
    <Layout title={t("pageTitle.privacy")}>
      ...
      <article className="info-template-container">
        <div className="info-template-main-content" data-test-id="assistance-main-content">
          <InformationalContent>
            <InformationalSection>
              <InformationalStack>
                <h2>{t("privacyPolicy.infoCollectionTitle")}</h2>
                <ul className="info-template-list info-template-list--unordered info-template-list--compact">
