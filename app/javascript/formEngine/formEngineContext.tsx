...
export interface FormEngineContext {
  ...
  handleSetSectionCompletion: (sectionName: string | undefined, isComplete: boolean) => void
}
...
export const useFormEngineContext = () => {
  ...
  if (context === undefined) {
    throw new Error("useFormEngineContext must be used within a FormEngineProvider")
  }
