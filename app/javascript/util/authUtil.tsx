...
export const localization: LocalizationResource = {
  locale: "en-US", //TOOD: dynamic based on user langauge
  apiKeys: {
  ...
  billing: {
    ...
    pricingTable: {
      ...
      seatCost: {
        ...
        additionalSeats:
          "({{additionalTierFeePerBlockAmount}}/{{periodAbbreviation}} for additional)",
  ...
  oauthConsent: {
    ...
    redirectUriModal: {
      subtitle:
        "Make sure you trust {{applicationName}} and that this URL belongs to {{applicationName}}.",
      title: "Redirect URL",
    },
    scopeList: {
  ...
  signIn: {
    ...
    start: {
      ...
      titleCombined: "Sign in or create account",
    },
    totpMfa: {
      formTitle: "Verification code",
      subtitle:
  ...
  taskSetupMfa: {
    ...
    start: {
      ...
      subtitle:
        "Choose which method you prefer to protect your account with an extra layer of security",
  ...
  unstable__errors: {
    ...
    form_username_needs_non_number_char:
      "Your username must contain at least one non-numeric character.",
    ...
    web3_signature_request_rejected:
      "You have rejected the signature request. Please try again to continue.",
