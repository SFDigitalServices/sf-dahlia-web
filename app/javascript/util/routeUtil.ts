...
export const getAccountDashboardPath = localizedPathGetter("/account")
export const getAccountApplicationsPath = localizedPathGetter("/account/applications")
export const getAccountSettingsPath = localizedPathGetter("/account/settings")
