...
export const rentalEducatorListing1: RailsRentalListing = {
  unitSummaries: {
    reserved: null,
    general: [
      {
...
export const rentalEducatorBrightwellListing: RailsRentalListing = {
  unitSummaries: {
    reserved: null,
    general: [
      {
  ...
  attributes: {
    type: "Listing",
    url: "/services/data/v35.0/sobjects/Listing/a0Wbb000002L0YXEA0",
  },
  Name: "Brightwell West",
  Allows_Realtor_Commission: false,
  Tenure: "Re-rental",
  First_Come_First_Served: false,
  Building: {
