...
export const rentalEducatorListing1complete: RailsRentalListing = {
  unitSummaries: {
    reserved: undefined,
    general: [
      {
        unitType: "SRO",
        totalUnits: 1,
        minSquareFt: undefined,
        minRentalMinIncome: 5255,
        minPriceWithParking: undefined,
        minPriceWithoutParking: undefined,
        minPercentIncome: undefined,
        minOccupancy: 1,
        minMonthlyRent: 2102,
        minHoaDuesWithParking: undefined,
        minHoaDuesWithoutParking: undefined,
        maxSquareFt: undefined,
        maxRentalMinIncome: 5255,
        maxPriceWithParking: undefined,
        maxPriceWithoutParking: undefined,
        maxPercentIncome: undefined,
        maxOccupancy: 1,
        maxMonthlyRent: 2102,
        maxHoaDuesWithParking: undefined,
        maxHoaDuesWithoutParking: undefined,
  ...
  reservedDescriptor: undefined,
  prioritiesDescriptor: undefined,
  listingID: "a0W4U00000HnVLJUA3",
  chartTypes: [
    {
      year: "2016",
...
export const rentalEducatorListing2: RailsRentalListing = {
  unitSummaries: {
    reserved: undefined,
    general: [
      {
