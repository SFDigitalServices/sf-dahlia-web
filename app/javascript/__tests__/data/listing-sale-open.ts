...
export const openSaleListing: RailsSaleListing = {
  ...
  // attributes: {
  //   type: "Listing",
  //   url: "/services/data/v35.0/sobjects/Listing/a0W0P00000F8YG4UAN",
  // },
