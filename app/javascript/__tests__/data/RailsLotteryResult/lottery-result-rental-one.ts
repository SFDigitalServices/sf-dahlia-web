...
/**
 * LotteryResult for a rental listing with L/W preference rank
 */
export const lotteryResultRentalOne: RailsLotteryResult = {
  URL: null,
      ...
      preferenceResults: [
        {
          preferenceRank: 15,
          lotteryRank: 19,
          lotteryNumber: "00973189",
          applicationID: "a0o4U00000KTnZsQAL",
        },
      ],
      preferenceOrder: 3,
