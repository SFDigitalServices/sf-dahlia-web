...
const MyApplicationsPageWithSession = () => (
  <AuthSessionProvider>
...
describe("<MyApplicationsPage />", () => {
  ...
  describe("when the user is not signed in", () => {
    ...
    it("redirects to the sign in page", async () => {
      const { queryByText } = await renderAndLoadAsync(<MyApplicationsPageWithSession />)
  ...
  describe("when a user is signed in", () => {
    ...
    it("calls getApplications", async () => {
      await renderAndLoadAsync(<MyApplicationsPageWithSession />)
