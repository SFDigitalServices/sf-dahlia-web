...
ShortFormApplicationController = (
  ...
  $scope.rtrTranslationKeys = ->
    switch $scope.getRTRPreferenceKey()
      ...
      when 'rightToReturnPotrero'
        return key =
          desc: $translate.instant("preferences.rtr_potrero.desc")
          title: $translate.instant("preferences.rtr_potrero.title")
          addressTitle: $translate.instant("preferences.rtr_potrero.address")
          addressDesc: $translate.instant("preferences.rtr_potrero.address_desc")
...
########## END VETERANS PREFERENCE LOGIC ##########
  ...
  $scope.goToDemographicsPageUnlessAutofilled = ->
    console.log('ShortFormApplicationService.APPLICATION_AUTOFILL_IMPROVEMENTS', ShortFormApplicationService.APPLICATION_AUTOFILL_IMPROVEMENTS)
