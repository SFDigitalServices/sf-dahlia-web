Feature: Short Form Application - Custom Educator Listing 2
    As a web user
    I should be able to apply to Custom Educator Listing 2

    Scenario: Answering "Yes" to the "Do you work at San Francisco Unified School District?" question
        # Screening page
        Given I go to the welcome page of the "Custom Educator 2 Test Listing" application
