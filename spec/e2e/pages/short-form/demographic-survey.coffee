...
class DemographicSurvey extends AngularPage
  constructor: ->
    ...
    @indigenousNativeAmericanCheckbox = element(By.id('panel-label-Indigenous-American Indian/Native American'))
    @indigenousNativeAmericanText = element(By.id('panel-label-Indigenous-American Indian/Native American-text'))
    @indigenousCentralSouthAmericaCheckbox = element(By.id('panel-label-Indigenous-Indigenous from Mexico, the Caribbean, Central America, or South America'))
    @indigenousCentralSouthAmericaText = element(By.id('panel-label-Indigenous-Indigenous from Mexico, the Caribbean, Central America, or South America-text'))
  ...
  fill: (opts = {}) ->
    ...
    # have to wait for the text element to be enabled after checkbox changed
    browser.waitForAngular()
    @indigenousNativeAmericanText.clear().sendKeys(@defaults.indigenousNativeAmericanGroup)
    @indigenousCentralSouthAmericaText.clear().sendKeys(@defaults.indigenousCentralSouthAmericaGroup)
