...
/*
 * Vendored from @bloom-housing/ui-components/tailwind.config.js.
 *
 * This is the base Tailwind theme that used to ship with the package. It is
 * consumed by the repo's top-level tailwind.config.js (which layers a few
 * overrides on top) and, via tailwindToSass.js, by the webpack sass loader to
 * generate the $screen-* / $tailwind-* SCSS variables. All color/size/font
 * values resolve to the --bloom-* CSS custom properties defined in
 * app/javascript/components/uic/global/tokens/*.scss.
 */
module.exports = {
  important: true,
  purge: false,
