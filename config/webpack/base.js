...
generatedWebpackConfig.plugins.unshift(
  new webpack.DefinePlugin({
    "process.env": {
      ...
      FCFS_FORM_URL_EN: JSON.stringify(process.env.FCFS_FORM_URL_EN),
      FCFS_FORM_URL_ES: JSON.stringify(process.env.FCFS_FORM_URL_ES),
      FCFS_FORM_URL_ZH: JSON.stringify(process.env.FCFS_FORM_URL_ZH),
      FCFS_FORM_URL_TL: JSON.stringify(process.env.FCFS_FORM_URL_TL),
